...
final class Image
{
     ...
     */
    public static function store(array $file, $folder = 'general', $maxWidth = 1600)
    {
        ...
        $base = self::relativeBase($folder, isset($file['name']) ? $file['name'] : 'imagen');
    ...
    public static function generatePwaIcons($relBase, $bg = '#0C0B09')
    {
