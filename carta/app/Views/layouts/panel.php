...
<div class="layout">
  <aside class="side" id="side">
    ...
    <div class="side-place">
      <b><?= e($cfg['name']) ?></b>
      <p style="margin-top:.5rem"><a class="link-line gold" href="<?= e(mg_url('/')) ?>" target="_blank" rel="noopener">Ver el menú →</a></p>
    </div>
    ...
    <nav aria-label="Menú del panel">
      ...
      <div class="side-group">
        ...
        <?php if (Auth::can('customers')): ?>
          ...
          <a class="side-link <?= $is('/panel/menu/cupones') ? 'is-on' : '' ?>" href="<?= e(mg_url('/panel/menu/cupones')) ?>"><?= $icon('tag') ?> Cupones</a>
        <?php endif; ?>
...
<script>window.MG_PANEL = <?= json_encode(array(
    ...
    'lateMin'   => \MenuGold\Models\Settings::int('kds_late_min', 18),
    'sound'     => \MenuGold\Models\Settings::bool('kds_sound', true),
