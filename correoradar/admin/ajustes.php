...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="hoja tarjeta" id="h-motor">
    ...
    fila('Prefijo de país por defecto',
        ...
        . 'Si lo rellenas, CorreoRadar también reconocerá los números escritos en formato local (2222&nbsp;3333). '
    ...
    fila('Identificación del navegador', 'Cabecera User-Agent con la que CorreoRadar se presenta ante los sitios.',
    ...
    fila('Navegador interno (JavaScript)',
        ...
        . 'La mayoría de hosting compartidos no lo permiten; en ese caso CorreoRadar avisa y sigue funcionando sin él.',
