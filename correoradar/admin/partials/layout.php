<?php
/**
 * CorreoRadar - Estructura del panel de administración (cabecera y pie).
 */
...
function admin_cabecera(array $opciones = []): void
{
    ...
    $nombre  = Ajustes::obtener('sitio_nombre', 'CorreoRadar');
  ...
  if (pestanas.length) {
    Array.prototype.forEach.call(pestanas, function (b) {
      b.addEventListener('click', function () {
        ...
        try { localStorage.setItem('correoradar-hoja', b.dataset.hoja); } catch (e) {}
      });
    });
    var recordada = null;
    try { recordada = localStorage.getItem('correoradar-hoja'); } catch (e) {}
