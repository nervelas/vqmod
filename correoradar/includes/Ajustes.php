<?php
/**
 * CorreoRadar - Ajustes del sitio (tabla cr_ajustes).
 *
...
final class Ajustes
{
    ...
    public static function porDefecto(): array
    {
        return [
            ...
            'sitio_lema'          => 'Radar de correos electrónicos',
            'sitio_descripcion'   => 'Extrae todos los correos electrónicos de cualquier página web en un solo clic.',
            'logo'                => '',
            'favicon'             => '',
            'pie_texto'           => '© CorreoRadar. Uso responsable: extrae solo datos públicos y respeta la legislación de protección de datos.',

            // --- Textos de la portada --------------------------------------
            'hero_titulo'         => 'Encuentra cada correo de cualquier web',
            'hero_subtitulo'      => 'Pega un enlace y CorreoRadar barre el código, los enlaces mailto, las ofuscaciones y hasta los correos protegidos por Cloudflare.',
            'hero_placeholder'    => 'https://ejemplo.com/contacto',
            'hero_boton'          => 'Extraer correos',
            'hero_etiqueta'       => 'Pega tu enlace',
            'aviso_legal'         => 'Usa CorreoRadar solo sobre sitios propios o con autorización. No envíes correo no solicitado.',
            ...
            // --- Acceso y límites ------------------------------------------
            'acceso_publico'      => '1',   // 0 = solo usuarios con cuenta
            'registro_publico'    => '1',   // 0 = solo el administrador crea cuentas
    ...
    public static function cargar(bool $forzar = false): void
    {
        ...
        try {
            ...
            error_log('CorreoRadar / ajustes: ' . $e->getMessage());
        }
        self::$cargado = true;
    }
