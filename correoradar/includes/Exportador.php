<?php
/**
 * CorreoRadar - Exportación de resultados.
 *
 ...
 *   correoradar-midominio-com-2026-09-18.xlsx
 */
...
final class Exportador
{
    ...
    public static function nombreArchivo(array $escaneo, string $extension, string $datos = 'correos'): string
    {
        ...
        return 'correoradar-' . $host . $sufijo . '-' . $fecha . '.' . $extension;
    }
    ...
    public static function csv(array $correos, array $telefonos, array $escaneo, string $datos): string
    {
        ...
        $linea(['CorreoRadar - ' . (string) $escaneo['url_origen']]);
    ...
    {
        $libro = new XlsxEscritor('CorreoRadar · ' . (string) $escaneo['host']);
