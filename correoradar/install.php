...
$datos   = [
    ...
    'sitio_nombre'  => $_POST['sitio_nombre']  ?? 'CorreoRadar',
...
if (!$yaInstalado && !$faltaAlgo && ($_SERVER['REQUEST_METHOD'] ?? '') === 'POST' && isset($_POST['instalar'])) {
    ...
    if (!$errores && $pdo instanceof PDO) {
        try {
            ...
            @file_put_contents($rutaLock, 'Instalado el ' . date('d/m/Y H:i:s') . ' - CorreoRadar ' . CR_VERSION . "\n");
...
<title>Instalación de CorreoRadar</title>
...
<?php if ($yaInstalado && !$hecho): ?>
  ...
  <div class="panel">
    <h2>CorreoRadar ya está instalado</h2>
    ...
    <a class="btn-enlace" href="index.php">Ir a CorreoRadar</a>
...
<?php elseif ($hecho): ?>
  ...
  <div class="panel">
    ...
    <a class="btn-enlace" href="index.php">Abrir CorreoRadar</a>
...
<?php else: ?>
  ...
  <form method="post" autocomplete="off">
    ...
    <div class="panel">
      ...
      <input type="text" id="db_nombre" name="db_nombre" value="<?= h($datos['db_nombre']) ?>" required placeholder="micuenta_correoradar">
      <div class="fila">
        <div>
    ...
    <div class="panel">
      ...
      <button type="submit" name="instalar" value="1">Instalar CorreoRadar</button>
    </div>
  </form>
  <?php endif; ?>
...
<?php endif; ?>
  ...
  <p class="pie">CorreoRadar <?= h(CR_VERSION) ?> · Extractor de correos profesional</p>
</div>
</body>
</html>
