<?php
/**
 * Kaptor - Generador de archivos Excel .xlsx reales.
 *
...
final class XlsxEscritor
{
    ...
    public function __construct(private string $tituloLibro = 'Kaptor') {}
    ...
    private function propsCore(): string
    {
        ...
        return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
            ...
            . '<dc:creator>Kaptor</dc:creator>'
            . '<cp:lastModifiedBy>Kaptor</cp:lastModifiedBy>'
    ...
    private function propsApp(): string
    {
        return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
            ...
            . '<Application>Kaptor</Application><Company></Company>'
            . '</Properties>';
    }
