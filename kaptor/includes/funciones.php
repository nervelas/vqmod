...
function cr_icono_area(string $area): string
{
    $trazos = [
        ...
        // Código malicioso: un bicho.
        'malware'   => '<path d="M8.6 8.2h6.8v5.6a3.4 3.4 0 0 1-3.4 3.4 3.4 3.4 0 0 1-3.4-3.4V8.2Z"/>'
                     . '<path d="M8.6 8.2a3.4 3.4 0 0 1 6.8 0"/>'
                     . '<path d="M8.6 10.6H4.4M15.4 10.6h4.2M8.6 14.4H5.2M15.4 14.4h3.4"/>'
                     . '<path d="M9.4 5.6 7.8 3.6M14.6 5.6l1.6-2M8.8 18.4l-1.4 2.2M15.2 18.4l1.4 2.2"/>',
        // IA: una chispa.
