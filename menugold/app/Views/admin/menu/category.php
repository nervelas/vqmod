      ...
      <div class="card">
        ...
        <div class="grid grid-2">
          <div class="field"><label for="available_from">Desde</label>
            <input class="input" id="available_from" name="available_from" type="time" value="<?= e($c && $c['available_from'] ? substr($c['available_from'], 0, 5) : '') ?>"></div>
          <div class="field"><label for="available_to">Hasta</label>
            <input class="input" id="available_to" name="available_to" type="time" value="<?= e($c && $c['available_to'] ? substr($c['available_to'], 0, 5) : '') ?>"></div>
        </div>
        <p class="field-hint">Déjalos vacíos para mostrarla todo el día (útil para desayunos).</p>
      </div>
    </div>
  </div>
