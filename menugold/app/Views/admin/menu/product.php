    ...
    <div class="stack">
      ...
      <div class="card">
        ...
        <div class="grid grid-2">
          ...
          <div class="field"><label for="compare_price">Precio tachado</label>
            <input class="input" id="compare_price" name="compare_price" type="number" step="0.01" min="0" value="<?= e($p ? $p['compare_price'] : '') ?>"></div>
          <div class="field"><label for="cost">Costo interno</label>
            <input class="input" id="cost" name="cost" type="number" step="0.01" min="0" value="<?= e($p ? $p['cost'] : '') ?>">
            <p class="field-hint">Solo tú lo ves.</p></div>
          ...
          <div class="field"><label for="calories">Calorías</label>
            <input class="input" id="calories" name="calories" type="number" min="0" max="9999" value="<?= e($p ? $p['calories'] : '') ?>"></div>
          <div class="field"><label for="sku">Código interno</label>
            <input type="text" class="input" id="sku" name="sku" maxlength="40" value="<?= e($p ? $p['sku'] : '') ?>"></div>
        </div>
      ...
      <div class="card">
        ...
        <div class="stack" style="gap:.8rem">
          ...
          <label class="switch"><input type="checkbox" name="is_out_of_stock" value="1" <?= $p && (int)$p['is_out_of_stock'] === 1 ? 'checked' : '' ?>><span class="switch-track" aria-hidden="true"></span><span>Agotado hoy</span></label>
        </div>
