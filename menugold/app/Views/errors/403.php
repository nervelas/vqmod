...
<main style="min-height:100svh;display:grid;place-items:center;text-align:center;padding:2rem">
  <div class="shell-narrow">
    <p class="numeral" style="font-size:var(--step-4);letter-spacing:.1em">403</p>
    <h1 class="display" style="font-size:var(--step-3);margin:1rem 0">Zona reservada</h1>
    <p class="lead" style="margin-inline:auto"><?= e(isset($message) ? $message : 'No tienes permiso para ver esta página.') ?></p>
