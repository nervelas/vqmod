...
<link rel="canonical" href="<?= e(Url::abs('/r/' . $r['slug'])) ?>">
<meta property="og:type" content="restaurant.menu">
<meta property="og:title" content="<?= e($title) ?>">
<meta property="og:description" content="<?= e($desc) ?>">
<meta property="og:url" content="<?= e(Url::abs('/r/' . $r['slug'])) ?>">
<?php if ($og !== ''): ?><meta property="og:image" content="<?= e($og) ?>"><?php endif; ?>
<meta name="twitter:card" content="summary_large_image">

<link rel="manifest" href="<?= e(mg_url('/r/' . $r['slug'] . '/manifest.webmanifest')) ?>">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="apple-mobile-web-app-title" content="<?= e(mb_substr($r['name'], 0, 12)) ?>">
<?php
$iconDir = '/uploads/' . (int)$r['id'] . '/icons/icon-192.png';
...
<script>window.MG_MENU = <?= json_encode(array(
    ...
    'zones'    => isset($zones) ? array_map(function ($z) {
                      return array('id' => (int)$z['id'], 'name' => $z['name'], 'fee' => (float)$z['fee'],
                                   'min_order' => (float)$z['min_order'], 'eta' => (int)$z['eta_minutes']);
                  }, $zones) : array(),
    'tip'      => (int)$r['tip_enabled'] === 1,
