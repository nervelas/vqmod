...
<div class="sheet" style="margin-top:0;border-radius:0">
  <div class="menu-bar">
    <div class="menu-bar-top">
      <a class="icon-btn" href="<?= e(mg_url('/r/' . $r['slug'])) ?>" aria-label="Volver al menú">
  ...
  <div style="max-width:760px;margin-inline:auto">
    ...
    <div class="sheet-content">
      ...
      <p class="mt-2">
        <a class="btn btn-block" href="<?= e(mg_url('/r/' . $r['slug'])) ?>#<?= e('cat-' . (int)$p['category_id']) ?>">Volver al menú y pedir</a>
      </p>
