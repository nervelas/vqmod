        ...
        if ($enviarCorreo) {
            Correo::enviar(
                ...
                Correo::plantillaHtml(
                    ...
                    . '<tr><td style="padding:8px 0;color:#6E6A61">Usuario</td><td style="padding:8px 0"><strong>' . e($usuario) . '</strong></td></tr>'
                    . '<tr><td style="padding:8px 0;color:#6E6A61">Contraseña temporal</td><td style="padding:8px 0"><strong>' . e($clave) . '</strong></td></tr>'
                    . '</table>'
