<div style="min-height:100dvh;display:grid;place-items:center;padding:24px;background:linear-gradient(160deg,var(--marca-3),var(--marca))">
  <div style="text-align:center;max-width:460px;color:#E9EEE9">
    <div style="width:84px;height:84px;margin:0 auto 22px;border-radius:50%;display:grid;place-items:center;background:rgba(201,169,97,.16);color:var(--acento-2)">
      <?= ico('rayo', 40) ?>
    </div>
    ...
    <p style="color:rgba(233,238,233,.6);font-size:.88rem">Si está en la garita, puede seguir registrando ingresos: quedarán guardados en el dispositivo y se enviarán solos cuando vuelva la conexión.</p>
