<div class="rejilla rejilla-2">
  <article class="tarjeta">
    ...
    <div class="tarjeta-cuerpo compacto">
      <ul class="lista-limpia">
        <?php if ($reglamento !== ''): ?>
          <li class="item-lista">
            <span style="color:var(--acento-3)"><?= ico('libro', 20) ?></span>
        ...
        <?php foreach ($documentos as $d): ?>
          <li class="item-lista">
            <span style="color:var(--acento-3)"><?= ico('archivo', 20) ?></span>
  ...
  <article class="tarjeta">
    ...
    <div class="tarjeta-cuerpo compacto">
      <ul class="lista-limpia">
        <li class="item-lista">
          <span style="color:var(--acento-3)"><?= ico('billetera', 20) ?></span>
        ...
        <li class="item-lista">
          <span style="color:var(--acento-3)"><?= ico('escudo', 20) ?></span>
        ...
        <li class="item-lista">
          <span style="color:var(--acento-3)"><?= ico('barras', 20) ?></span>
