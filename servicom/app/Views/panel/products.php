      ...
      <table class="datatable" style="border:0;border-radius:0">
        ...
        <tbody>
          <?php foreach ($rows as $p): $img = $p['image'] ?? null; ?>
            <tr>
              <td style="width:56px"><img class="thumb" src="<?= e($img ? upload($img['path_thumb'] ?: $img['path']) : url('/assets/img/cards/generico.svg')) ?>" alt="" aria-hidden="true" loading="lazy" width="46" height="36"></td>
