...
$ogImg  = $ogImage ?? (isset($company['og_image']) && $company['og_image'] ? upload($company['og_image']) : (isset($company['hero_image']) && $company['hero_image'] ? upload($company['hero_image']) : absUrl('/assets/img/cards/sitio-corporativo.svg')));
