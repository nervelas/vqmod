...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `theme`             VARCHAR(30)  NOT NULL DEFAULT 'servicom',
  `color_accent`      VARCHAR(9)   NOT NULL DEFAULT '#1D5BFF',
  `color_ink`         VARCHAR(9)   NOT NULL DEFAULT '#0A1024',
  `color_paper`       VARCHAR(9)   NOT NULL DEFAULT '#F6F8FC',
